...
public interface IConstantes {
	...
	public static final int MAX_PWD = 15;
	...
	public static final int MIN_EVENT_DESCRIPTION = 1;
	public static final int MAX_EVENT_DESCRIPTION = 45;
	public static final int MIN_EVENT_PLACE = 1;
	public static final int MAX_EVENT_PLACE = 45;
	public static final int MIN_EVENT_DURATION = 1;
	public static final int MAX_EVENT_DURATION = 45;
	public static final int MIN_EVENT_TYPE = 1;
	public static final int MAX_EVENT_TYPE = 45;
	public static final int MIN_SEATS_AVAILABLE = 0;
	...
	public static final String ERM_015 = "Invalid First Name";
	public static final String ERM_016 = "Invalid Last Name";
